...
from random_mode_player4 import RandomModePlayer
...
class PianoLearningApp(QMainWindow):
    ...
    def create_control_panel(self):
        ...
        self.mode_combo.addItems(["Song Mode", "Jazz Theory Mode", "Relaxation Mode"])
    ...
    def switch_mode(self, mode):
        if mode == "Song Mode":    
            ...
            self.piano_display.reset()
            self.all_notes_off()
            selected_mode = self.relax_mode_combo.currentText().split()[0]  # "Mixed", "Only Impro", "Only Chords"
