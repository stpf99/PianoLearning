...
class PianoLearningApp(QMainWindow):
    ...
    def create_control_panel(self):
        ...
        # Dodajemy rozwijane listy stylów elektroniki i artystów
        style_layout = QHBoxLayout()
        style_layout.addWidget(QLabel("Style:"))
        self.style_combo = QComboBox()
        self.style_combo.addItems([
            "Arp", "Chords", "Bassline", "Lead", "Pad", "Pluck",
            "Drum Pattern", "Synth Stab", "Ambient Texture", "Breakbeat"
        ])
        ...
        self.artist_combo.addItems([
            "Deadmau5", "Skrillex", "Aphex Twin", "Daft Punk", "Calvin Harris",
            "The Chainsmokers", "Justice", "Disclosure", "Four Tet", "Bonobo"
        ])
        ...
        control_layout.addLayout(artist_layout)
    ...
    def query_ollama_composer(self, prompt):
        ...
        payload = {
            "model": "gemma3:27b",  # Użyto gemma:2b, zmień na gemma3:1b jeśli dostępny
            "prompt": prompt,
            "stream": False
        }
        try:
    ...
    def show_about(self):
        QMessageBox.about(self, "About Piano Learning App",
                         ...
                         "Now with AI composition using Ollama for electronic music!")
